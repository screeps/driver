global._init = (function() {
    ...
    global._start = function (data) {
            ...
            set: {
                value: function (value) {
                    ...
                    if(value instanceof ArrayBuffer && Object.prototype.toString.call(value) === '[object ArrayBuffer]'){
                        ...
                        throw new Error('Raw memory value is not a string or ArrayBuffer');
                    }
        ...
        var outMessage = Object.create(null);
        ...
        return new ivm.Reference(function() {
            ...
            outMessage.intents = utils.storeIntents(data.user._id, intents.list, data, customIntentTypes);
