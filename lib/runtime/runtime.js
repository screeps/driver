global._init = (function() {
    ...
    global._setStaticTerrainData = function (room, staticTerrainRoomData) {
        staticTerrainData[room] = staticTerrainRoomData;
    };
    ...
    global._start = function (data) {
        ...
        let startTime, startDirtyTime = ivm.lib.hrtime();
        let intentCpu = 0.2,
        ...
        var getUsedCpu = function () {
            var elapsed = ivm.lib.hrtime(startTime);
        ...
        return new ivm.Reference(function() {
            ...
            outMessage.usedTime = ivm.lib.hrtime(startTime);
            outMessage.usedTime = Math.ceil(outMessage.usedTime[0] * 1e3 + outMessage.usedTime[1] / 1e6 + intents.cpu);

            outMessage.usedDirtyTime = ivm.lib.hrtime(startDirtyTime);
